...
if(Npcinteract > 0)
{
	...
	else
	{
		...
		/// @DnDHash : 43B78983
		/// @DnDParent : 06602A0C
		/// @DnDArgument : "code" "draw_text_ext_transformed(30, 650, string("Colleague: ") + string("Here's the Mission selection station. Here you can see descriptions of situations people need rescuing from."), 25, 550, 2, 2, 0)$(13_10)"
		draw_text_ext_transformed(30, 650, string("Colleague: ") + string("Here's the Mission selection station. Here you can see descriptions of situations people need rescuing from."), 25, 550, 2, 2, 0)
